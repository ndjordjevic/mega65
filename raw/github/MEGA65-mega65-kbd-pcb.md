# MEGA65/mega65-kbd-pcb

## Metadata
- Stars: 6
- Primary language: none (KiCad PCB design files)
- Default branch: master
- Latest release: none
- License: CC-BY-SA 4.0 (stated in README)
- Homepage: https://mega65.org
- Fetched: 2026-06-13
- Final URL: https://github.com/MEGA65/mega65-kbd-pcb
...
## Top-level structure
- `.gitmodules` — git submodule config (library submodule)
- `README.md` — project documentation
- `fp-info-cache` — KiCad footprint info cache (binary-ish, 3 MB)
- `fp-lib-table` — KiCad footprint library table
- `keyswitches.kicad_sch` — KiCad schematic for key switches (170 kB)
- `library/` — git submodule (KiCad library assets; empty in clone)
- `mega65-kbd.kicad_pcb` — main PCB layout file (5.5 MB)
- `mega65-kbd.kicad_prl` — KiCad local project settings
- `mega65-kbd.kicad_pro` — KiCad project file
- `mega65-kbd.kicad_sch` — top-level KiCad schematic (208 kB)

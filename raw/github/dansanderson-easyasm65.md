...
- Default branch: main
- Latest release: v0.1 "EasyAsm v0.1: Initial release" (2024-08-23); README documents v0.2
- License: GPL-3.0
- Forks: 3
- Pushed: 2025-04-28
- Fetched: 2026-06-10
- Final URL: https://github.com/dansanderson/easyasm65

## Description
An on-device assembler for the MEGA65.

## README (full — this is the complete EasyAsm manual)
...
- file makedisk.py
- file oldtests.asm
- file test_common.asm
- file test_suite_1.asm
- file test_suite_2.asm
- file test_suite_3.asm
- dir testdata
- file typeme.txt
